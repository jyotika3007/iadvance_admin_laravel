            ...
            <div class="box">
                <div class="box-body">
                    <h2>Sub Admins - Search result for <b><i>"{{ $keyword }}"</i></b></h2>
                     ...
                     @include('layouts.search', ['route' => route('admin.subadmins.search_customers'), 'placeholder' => 'Search by subadmins name, email name ... ' , 'keyword' => $keyword])
        @if($subadmins)
                                ...
                                <td>
                                    <form action="{{ route('admin.subadmins.destroy', $subadmin['id']) }}" method="post" class="form-horizontal">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <a href="{{ route('admin.subadmins.edit', $subadmin['id']) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Edit</a>
