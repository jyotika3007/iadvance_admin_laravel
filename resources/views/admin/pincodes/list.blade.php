...
<h3>Pincodes @if(!empty($keyword))  - Search result for - <b><i>"{{ $keyword }}"</i></b> @endif </h3>
                    ...
                    <div class="row"  >
                        ...
                        <div class="col-sm-2">
                            <a href="{{ route('admin.pincodes.create') }}"  class="btn btn-primary">Add New</a>
                        </div>
                    </div>
                </form>
                    <br>
                            ...
                            <td>@include('layouts.status', ['status' => $pincode->status ?? '0'])</td>
                                ...
                                <td>
                                    <form action="{{ route('admin.pincodes.destroy', $pincode->id) }}" method="post" class="form-horizontal">
                                        ...
                                        <div class="btn-group">
                                            <a href="{{ route('admin.pincodes.edit', $pincode->id) }}" class="btn btn-default btn-sm"><i class="fa fa-edit"></i></a>
