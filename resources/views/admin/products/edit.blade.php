                    ...
                    <div class="col-md-12">
                        ...
                        <div class="tab-content" id="tabcontent">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $product->stock_quantity }}" class="form-control" readonly required="required">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon">{{ config('cart.currency') }}</span>
                                <input type="number" name="discount" id="discount" placeholder="Discount" class="form-control" value=""  onkeyup="handleDiscount(this)">
                            </div>
                        </div>
                                            ...
                                            <div class="form-group col-sm-6">
                                                ...
                                                <input type="text" name="color" id="color" placeholder="Color" class="form-control" value="{{ $product->color ?? '' }}">
