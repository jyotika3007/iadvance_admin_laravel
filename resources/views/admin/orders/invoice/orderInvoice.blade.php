...
<head>
    ...
    <title>Invoice - congig('app.name')</title>
         ...
         <div class="invoice-header">
            <div class="invoice-from">
               ...
               <address class="m-t-5 m-b-5">
                  <strong class="text-inverse">{{ $order->billing_address['address_1'] }}</strong><br>
                  {{'India'}} - ({{ $order->billing_address['zip'] }})<br>
            ...
            <div class="invoice-to">
               ...
               <address class="m-t-5 m-b-5">
                  <strong class="text-inverse">{{ $order->delivery_address['address_1'] }}</strong><br>
                  {{'India'}} - ({{ $order->delivery_address['zip'] }})<br>
                    ...
                    @php $gst+=($pro->gst*$item->quantity*$item->product_price)/100; @endphp
                     ...
                     <tr>
                      ...
                      @if($order->coupon_amount>0)
                                    ...
                                    @else
                                    <h2>Grand Total <span id="totalBill">Rs. {{$order->total}}</span></h2>
                                    <h2>Total Bachat <span id="couponDiscount">Rs. {{ number_format($mrp_total-$order->total,2,'.','.')  }}</span></h2>
                                    @endif
