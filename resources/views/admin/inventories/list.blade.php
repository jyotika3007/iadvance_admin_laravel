...
<h3>Inventory  @if(!empty($keyword))  - Search result for - <b><i>"{{ $keyword }}"</i></b> @endif </h3>
                    ...
                    <div class="row" style="border: 1px solid #ddd; width: 98%; margin: 1% 1%;padding: 15px; ">
                        ...
                        <div class="col-sm-2">
                            <a href="{{ route('admin.inventories.create') }}" class="btn btn-success">Add New</a>
                        </div>
                    </div>
                </form>
                    <br>
                                ...
                                <td>
                                    <form action="{{ route('admin.inventories.destroy', $inventory->id) }}" method="post" class="form-horizontal">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <!--<a href="{{ route('admin.inventories.edit', $inventory->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Edit</a>-->
