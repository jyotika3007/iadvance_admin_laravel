                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <p>Congratulations {{$shop->owner_name}}, Your request to connect with In Hand City is accepted successfully. Your account has been activated registered with this mail Id.  </p>
                                <p><b>Shop Name : </b>{{ $shop->shop_name ?? '' }}</p>
                                <p>Now you can login your portal from the given link - <a href="https://www.inhandcity.com/admin/login">Login</a></p>
                                <br>
                            </td>
                            <td width="10"></td>
                        </tr>
