            ...
            <form action="{{ route('admin.company_detail.store') }}" method="post" class="form" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="pincode" id="pincode" placeholder="Pincode" class="form-control" value="{{ old('pincode') }}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="contact" id="contact" placeholder="Contact Number" class="form-control" value="{{ old('contact') }}">
                        <p>Use comma (,) as a separator for multiple contact numbers</p>
                    </div>

                    <div class="form-group">
                        <label for="contact_email">Contact Email </label>
                        <input type="text" name="contact_email" id="contact_email" placeholder="Contact Email" class="form-control" value="{{ old('contact_email') }}">
