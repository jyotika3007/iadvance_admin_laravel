                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="pincode" id="pincode" placeholder="Pincode" class="form-control" value="{{ $company_detail->pincode ?? '' }}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="contact" id="contact" placeholder="Contact Number" class="form-control" value="{{ $company_detail->contact ?? '' }}">
