   ...
   <div class="col-md-12">
      <div class="invoice">
         ...
         <div class="invoice-company text-inverse f-w-600">
           ...
           <img src="{{ asset('storage/'.$companyInfor->company_logo ?? '') }}" height='150px'>
         </div>
        ...
        <div class="invoice-header">
            ...
            <div class="invoice-date">
               <small>Invoice /
               {{ date('M' ,strtotime(explode(' /',$order->booking_date)[0])) }} Period</small>
               <div class="date text-inverse m-t-5">{{ date('M d, Y',strtotime(explode(' /',$order->booking_date)[0])) }}</div>
