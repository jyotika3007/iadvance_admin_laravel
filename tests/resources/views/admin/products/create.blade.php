            ...
            <div class="box-body">
                ...
                <div class="col-md-8">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="sku" id="sku" placeholder="xxxxxxxxx" class="form-control" value="" required="required" >
                        <!-- <input type="text" name="sku" id="sku" placeholder="xxxxx" class="form-control" value="<?php echo 'INC'.rand(000,999999) ?>" required="required" readonly> -->
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="quantity" id="quantity" placeholder="Quantity" class="form-control" value="{{ old('quantity') }}"  required="required">
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="price" id="price" placeholder="Price" class="form-control" value="{{ old('price') }}"  required="required">
                            </div>
                        </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <input type="color" name="color" id="color" placeholder="Color" class="form-control" value="{{ old('color') }}">
