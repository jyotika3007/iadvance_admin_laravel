                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group" id="product">
                            ...
                            <label for="shop_name">Select Category<span class="text-danger">*</span></label>
                            <br>
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="cover" id="shopCover" class="form-control" required="required">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="contact" id="shopContact" placeholder="Shop Contact Number" class="form-control" required="required" pattern="[6-9]{1}[0-9]{9}" maxlength="10">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="alternate_contact" id="shopAlternateContact" placeholder="Alternate Contact Number" class="form-control" pattern="^\d+$">
                        </div> 
