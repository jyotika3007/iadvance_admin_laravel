                    ...
                    <form action="#">				
                        ...
                        <div class="cart-table table-responsive mb-40">
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="pro-thumbnail"><a href="#"><img src="{{ asset('assets/images/products/product01.jpg') }}" class="img-fluid" alt="Product"></a></td>
                                    ...
                                    <tr>
                                        <td class="pro-thumbnail"><a href="#"><img src="{{ asset('assets/images/products/product02.jpg') }}" class="img-fluid" alt="Product"></a></td>
                                    ...
                                    <tr>
                                        <td class="pro-thumbnail"><a href="#"><img src="{{ asset('assets/images/products/product03.jpg') }}" class="img-fluid" alt="Product"></a></td>
                                    ...
                                    <tr>
                                        <td class="pro-thumbnail"><a href="#"><img src="{{ asset('assets/images/products/product04.jpg') }}" class="img-fluid" alt="Product"></a></td>
