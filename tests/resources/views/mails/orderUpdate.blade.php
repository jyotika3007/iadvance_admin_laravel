                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <p>Congratulations {{$customer->name ?? 'User'}}, Your order has been placed successfully having <i><b>Order ID - {{$order->id}}</b></i> </p>
                                <p>Thank you for shopping at In Hand City.</p>
                                <br>
                            </td>
                            <td width="10"></td>
                        </tr>
